...
const demoIcons: FloatingIconsHeroProps['icons'] = [
  { id: 1, icon: IconGoogle, className: 'top-[15%] left-[18%]' },
  { id: 2, icon: IconApple, className: 'top-[20%] right-[18%]' },
  { id: 3, icon: IconMicrosoft, className: 'top-[75%] left-[20%]' },
  { id: 4, icon: IconFigma, className: 'bottom-[15%] right-[20%]' },
  { id: 5, icon: IconGitHub, className: 'top-[12%] left-[32%]' },
  { id: 6, icon: IconSlack, className: 'top-[10%] right-[32%]' },
  { id: 7, icon: IconVercel, className: 'bottom-[18%] left-[28%]' },
  { id: 8, icon: IconStripe, className: 'top-[45%] left-[12%]' },
  { id: 9, icon: IconDiscord, className: 'top-[70%] right-[28%]' },
  { id: 10, icon: IconX, className: 'bottom-[12%] right-[35%]' },
  { id: 11, icon: IconNotion, className: 'top-[45%] right-[12%]' },
  { id: 12, icon: IconSpotify, className: 'top-[50%] left-[8%]' },
  { id: 13, icon: IconDropbox, className: 'top-[15%] left-[55%]' },
  { id: 14, icon: IconTwitch, className: 'bottom-[15%] right-[48%]' },
  { id: 15, icon: IconLinear, className: 'top-[28%] right-[25%]' },
  { id: 16, icon: IconYouTube, className: 'top-[65%] left-[28%]' },
];
...
export default function InteractiveFloatingHero() {
  return (
    <FloatingIconsHero
      ...
      subtitle="Diskyazılım ile modern, performanslı ve ölçeklenebilir web ve mobil çözümlerini keşfedin. Markanızı geleceğin teknolojileriyle inşa ediyoruz."
